...
rule = ( IF( AND( '(?x) beats pair' ),
             THEN( '(?x) is a two-pair' )),
         IF( AND('(?x) beats two-pair' )),
             THEN( '(?x) is a three-of-a-kind' ),
         IF( AND('(?x) beats three-of-a-kind' ),
             THEN( '(?x) is a straight' )),
         IF( AND('(?x) beats straight' ),
             THEN( '(?x) is a flush' )),
         IF( AND('(?x) beats flush' ),
             THEN( '(?x) is a straight-flush' )),
         IF( AND'(?x) beats straight-flush' ),
             THEN( '(?x) is a full-house' )))
